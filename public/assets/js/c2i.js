...
! function(A, e) { "object" == typeof exports && "undefined" != typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define(e) : (A = A || self).html2canvas = e() }(this, function() {
    ...
    var LB, OB, vB = { integers: [1e3, 900, 500, 400, 100, 90, 50, 40, 10, 9, 5, 4, 1], values: ["M", "CM", "D", "CD", "C", "XC", "L", "XL", "X", "IX", "V", "IV", "I"] },
    ...
    function ds(A, e, t) {
        var r = function(A, e) { return 0 === A ? e.bounds : 2 === A ? Hs(e) : hs(e) }(ms(A.styles.backgroundOrigin, e), A),
    ...
    }, bs.prototype.popEffect = function() { this._activeEffects.pop(), this.ctx.restore() }, bs.prototype.renderStack = function(e) {
        return a(this, void 0, void 0, function() {
            return S(this, function(A) {
                switch (A.label) {
                    case 0:
    ...
    }, bs.prototype.mask = function(A) { this.ctx.beginPath(), this.ctx.moveTo(0, 0), this.ctx.lineTo(this.canvas.width, 0), this.ctx.lineTo(this.canvas.width, this.canvas.height), this.ctx.lineTo(0, this.canvas.height), this.ctx.lineTo(0, 0), this.formatPath(A.slice(0).reverse()), this.ctx.closePath() }, bs.prototype.path = function(A) { this.ctx.beginPath(), this.formatPath(A), this.ctx.closePath() }, bs.prototype.formatPath = function(A) {
        var r = this;
    ...
    }, bs.prototype.renderRepeat = function(A, e, t, r) { this.path(A), this.ctx.fillStyle = e, this.ctx.translate(t, r), this.ctx.fill(), this.ctx.translate(-t, -r) }, bs.prototype.resizeImage = function(A, e, t) { if (A.width === e && A.height === t) return A; var r = this.canvas.ownerDocument.createElement("canvas"); return r.width = e, r.height = t, r.getContext("2d").drawImage(A, 0, 0, A.width, A.height, 0, 0, e, t), r }, bs.prototype.renderBackgroundImage = function(b) {
        return a(this, void 0, void 0, function() {
            var v, e, D, t, r, n;
            return S(this, function(A) {
                switch (A.label) {
                        ...
                        v = b.styles.backgroundImage.length - 1, e = function(e) {
                            ...
                            return S(this, function(A) {
                                switch (A.label) {
                                    ...
                                    case 5:
                                        ! function(A) { return A.type === xe.LINEAR_GRADIENT }(e) ? function(A) { return A.type === xe.RADIAL_GRADIENT }(e) && (C = ds(b, v, [null, null, null]), g = C[0], E = C[1], F = C[2], h = C[3], H = C[4], d = 0 === e.position.length ? [oe] : e.position, f = ae(d[0], h), p = ae(d[d.length - 1], H), N = function(A, e, t, r, n) {
                                            var B = 0,
                                                s = 0;
                                            switch (A.size) {
    ...
    var Ss = function(A) { return A instanceof Zn || (A instanceof Wn || A instanceof Jn && A.type !== Vn && A.type !== xn) },
        Ms = function(A, e) {
            switch (A) {
                case Ee.BORDER_BOX:
                    return Qs(e);
